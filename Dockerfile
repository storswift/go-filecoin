...
COPY --from=builder $SRC_DIR/proofs/rust-fil-proofs/target/release/libfilecoin_proofs.so /lib/libfilecoin_proofs.so
COPY --from=builder $SRC_DIR/proofs/rust-fil-proofs/target/release/libsector_base.so /lib/libsector_base.so
